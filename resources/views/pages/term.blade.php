...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <p>We employ the use of cookies. By accessing Cube Engineering, you agreed to use cookies in agreement with
                the Cube Engineering's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Cube Engineering and/or its licensors own the intellectual property rights for
                all material on Cube Engineering. All intellectual property rights are reserved. You may access this
                from Cube Engineering for your own personal use subjected to restrictions set in these terms and
                conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Cube Engineering</li>
                <li>Sell, rent or sub-license material from Cube Engineering</li>
                <li>Reproduce, duplicate or copy material from Cube Engineering</li>
                <li>Redistribute content from Cube Engineering</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Cube Engineering does not filter, edit, publish or review Comments prior
                to their presence on the website. Comments do not reflect the views and opinions of Cube Engineering,its
                agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, Cube Engineering shall not be liable for the
            ...
            <p>Cube Engineering reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>You hereby grant Cube Engineering a non-exclusive license to use, reproduce, edit and authorize others to
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Cube Engineering; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Cube Engineering. Please include your name, your
            ...
            <p>No use of Cube Engineering's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
